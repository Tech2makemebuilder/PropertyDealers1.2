                    ...
                    <div class="col-lg-12 login-form">
                        <form action="../Verification/otp.php">
                            ...
                            <div class="form-group">
                                ...
                                <input style="background-color: white; color:black;" type="text" class="form-control" pattern="[0-9]{10}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input style="background-color: white; color:black;" type="password" id="confirm_password" class="form-control" i required>
                            </div>
